...
* Wildcards for :ref:`admin-configuration-forcedownloadtype:forceDownloadType` and :ref:`admin-configuration-securedFileTypes:securedFileTypes`
...
* Following properties of the extension configuration are deprecated: :ref:`admin-configuration-debug:debug`, :ref:`admin-configuration-additionalMimeTypes:additionalMimeTypes` and :ref:`admin-configuration-domain:domain`
