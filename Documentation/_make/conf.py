# -*- coding: utf-8 -*-
#
# Secure Downloads documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 22 Jul 2016 14:30:52 +0200.
#
...
project = u'Secure Downloads'
copyright = u'2016, Florian Wessels, Helmut Hummel'
...
htmlhelp_basename = 'secure_downloadsdoc'
...
latex_documents = [
    ('Index', 'secure_downloads.tex', u'Secure Downloads',
     u'Florian Wessels, Helmut Hummel', 'manual'),
]
...
pdf_documents = [
    ('Index', 'secure_downloads', u'Secure Downloads',
     u'Florian Wessels, Helmut Hummel'),
]
...
man_pages = [
    ('Index', 'secure_downloads', u'Secure Downloads',
     [u'Florian Wessels, Helmut Hummel'], 1)
]
...
texinfo_documents = [
    ('Index', 'secure_downloads', u'Secure Downloads',
     u'Florian Wessels, Helmut Hummel', 'Secure Downloads', 'One line description of project.',
     'Miscellaneous'),
]
