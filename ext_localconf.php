...
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-output'][] = 'EXT:naw_securedl/Classes/Service/NawSecuredlService.php:&Bm\NawSecuredl\Service\NawSecuredlService->parseFE';
...
if  ($firstNumber >= 6) {
	...
	$GLOBALS['TYPO3_CONF_VARS']['SYS']['Objects']['TYPO3\\CMS\\Core\\Resource\\Driver\\LocalDriver'] = array(
		'className' => 'Bm\\NawSecuredl\Driver\\Xclass\\LocalDriver',
	);
}else{
