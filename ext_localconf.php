...
if  ($firstNumber >= 6) {
	...
	$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-output'][] = 'EXT:naw_securedl/Classes/Service/SecureDownloadService.php:&Bitmotion\NawSecuredl\Service\SecureDownloadService->parseFE';
} else {
	$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-output'][] = 'EXT:naw_securedl/Classes/Service/Tx_NawSecureDownloadService.php:&Tx_NawSecureDownloadService->parseFE';
