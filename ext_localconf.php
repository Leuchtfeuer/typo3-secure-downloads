...
if ($configurationManager->getValue('apacheDelivery')) {
    $objectManager->registerImplementation(\Bitmotion\SecureDownloads\Security\Authorization\Resource\AccessRestrictionPublisher::class,
...
$objectManager->registerImplementation(\Bitmotion\SecureDownloads\Resource\Publishing\ResourcePublishingTarget::class,
    $publishingTarget);
